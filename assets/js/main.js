...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const activityData = {
    ...
    'ROPE JUMPING': {
      ...
      zonas: ['Montanejos como referencia principal para Rope Jumping de pared'],
      disponibilidad: 'Convocatorias limitadas según calendario, grupo mínimo, empresa colaboradora, permisos y condiciones',
      ...
      ideal: 'Salto dinámico desde pared de aproximadamente 100 metros, con fase de caída libre y sistema específico de cuerdas; no es un simple péndulo de puente.',
      seguridad: 'Jump master y equipo técnico, doble arnés, casco, cuerdas y anclajes redundantes, conectores duplicados, seguro del operador, primeros auxilios, grupo reducido y potestad de cancelación.'
    },
    'PUENTING': {
      base: ['Salida especial desde Águilas'],
      zonaPrincipal: 'Mascarat, Calpe',
      zonas: ['Mascarat, entre Calpe y Altea, como referencia para el primer salto pendular'],
      ...
      ideal: 'Puenting de entrada para descubrir el salto pendular desde un puente autorizado, con briefing, control técnico y grabación opcional.',
  ...
  const ACTIVITY_SPECS = {
    ...
    'ROPE JUMPING': spec({f:'Salto dinámico de pared',d:'Salida de jornada; tiempo de salto y preparación según convocatoria.',e:'Edad mínima, peso y aptitud según operador autorizado.',fi:'Medio; salud adecuada y validación previa.',t:'Extremo y especializado.',x:'Entrevista, briefing reforzado y autocontrol; no se plantea como primer salto genérico.',r:'Grupo reducido según jump master, instalación y protocolo.',m:'Doble arnés, casco, dos sistemas de cuerda/anclaje, conectores redundantes y material del operador.',q:'Documentación, ropa cómoda, calzado cerrado y consentimiento si procede.',se:'Convocatorias limitadas y meteorología estable.',me:'Sin viento fuerte, lluvia, tormenta o acceso inseguro.',c:'Permisos, operador, meteorología, peso/edad fuera de rango o estado emocional no adecuado.',ri:'Caída libre, carga dinámica, impacto psicológico, arnés, acceso, evacuación y meteorología.',o:'Solo con empresa y jump master autorizados, permisos, seguro, primeros auxilios y validación técnica.',v:'Convocatoria limitada, GoPro, facecam, Insta360 y cámara lenta si la operación lo permite.'}),
    'PUENTING': spec({f:'Salto pendular desde puente',d:'2-4 h o convocatoria especial.',e:'Edad mínima y peso según operador autorizado; menores solo si el operador y la normativa lo permiten.',fi:'Medio; aptitud y salud adecuadas.',t:'Extremo de iniciación al salto con cuerda.',x:'Validación previa y briefing obligatorio; no requiere experiencia técnica cuando el operador lo admite.',r:'Grupo reducido según operador, instalación y protocolo.',m:'Arneses, cuerdas, anclajes, casco y redundancias según operador.',q:'Documentación, ropa cómoda, calzado cerrado y autorización si procede.',se:'Convocatorias concretas con meteorología estable.',me:'Sin lluvia, viento fuerte, tormenta o acceso inseguro.',c:'Permisos, operador, meteorología, peso/edad fuera de rango o estado emocional no adecuado.',ri:'Péndulo, impacto psicológico, arnés, evacuación, acceso y meteorología.',o:'Proveedor autorizado, normativa, permisos y seguro específico.',v:'Primer salto, salida especial y GoPro/facecam/360 si no afecta a seguridad.'}),
